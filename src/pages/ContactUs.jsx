                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <motion.div
                            ...
                            <div className="grid grid-cols-2 text-gray-400 gap-4">
                                {/* Phone Card */}
                                <div
                                    className=" p-4 border-r-2 border-indigo-100"
                                >
                                    <div className="flex flex-col items-center text-center">
                                        <div className="inline-flex items-center justify-center bg-indigo-950 text-white text-2xl p-3 rounded-full aspect-square">
                                            <FiPhone />
                                        </div>
                                ...
                                {/* Email Card */}
                                <div
                                    className=" p-4 border-b-2 border-indigo-100"
                                >
                                    <div className="flex flex-col items-center text-center">
                                        <div className="inline-flex items-center justify-center bg-indigo-950 text-white text-2xl p-3 rounded-full aspect-square">
                                            <FiMail />
                                ...
                                {/* Hours Card */}
                                <div
                                    className=" p-4 border-l-2 border-indigo-100"
                                >
                                    <div className="flex flex-col items-center text-center">
                                        <div className="inline-flex items-center justify-center bg-indigo-950 text-white text-2xl p-3 rounded-full aspect-square">
                                            <FiClock />
                        ...
                        <motion.div
                            ...
                            whileInView={{ opacity: 1, y: 0 }}
                            transition={{ duration: 0.6 }}
                            className="bg-[#dddddd] rounded-xl shadow-md p-6"
                        >
                            ...
                            <form className="space-y-4">
                                ...
                                <div className="bg-white p-4 rounded-lg">
                                    ...
                                    <input
                                        ...
                                        required
                                    />
                                    <div className="mt-2 p-2 w-28 bg-gray-100 rounded font-mono text-lg">
                                        p S † 5 s
                                    </div>
